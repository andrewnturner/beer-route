...
with_counts = pandas.merge(breweries, beer_counts, how='left', left_index=True, right_index=True)
data = pandas.merge(with_counts, geocodes, how='left', left_index=True, right_on="brewery_id")
